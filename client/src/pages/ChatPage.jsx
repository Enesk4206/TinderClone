...
const ChatPage = () => {
  ...
  }, [getMyMatches, authUser , getMessage, subscribeToMessages, unsubscribeToMessages , id]);
...
export default ChatPage
 ...
 const MatchNotFound = () => (
  <div className="h-screen flex flex-col items-center justify-center bg-gray-100 bg-dot-pattern">
    <div className="bg-white p-8 rounded-lg shadow-md text-center">
      <UserX size={64} className="mx-auto text-pink-500" />
      ...
      <Link
        to={"/"}
        className="mt-6 px-4 py-2 bg-pink-600 text-white rounded hover:bg-pink-600 transition-colors focus:outline-none
        focus:ring-2 focus:text-pink-300 inline-block"
      >
        Go Back to Home
      </Link>
    </div>
